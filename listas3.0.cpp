...
void mostrar3(const list<string> & frutas_);
void mostrar4(list<string> & frutas_);
main()
{
	//lista
	list <string> frutas;
	...
	cout<<"\nFrente: "<<*puntero;
	frutas.insert(puntero,"naranja");
	
	puntero=frutas.end();
	frutas.insert(puntero,"mandarina");
	//simple
	mostrar(frutas);
	//constante
	mostrar3(frutas);
...
void mostrar3(const list<string> & frutas_)
{
	...
	pos=frutas_.begin();
	cout<<"\n------------------"<<endl;
	cout<<"Los elementos de la lista con constante:"<<endl;
...
void mostrar4(list<string> & frutas_)
{
	...
	pos=frutas_.rbegin();
	cout<<"\n------------------"<<endl;
	cout<<"Los elementos de la lista al reves:"<<endl;
	
	while(pos != frutas_.rend())
	{
		cout <<*pos<<endl;
		pos++; 
	}
